      ...
      <div className="max-w-4xl mx-auto bg-[#6A5F56] rounded-lg shadow-xl p-5">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="bg-[#F4A321] hover:bg-[#E09419] text-[#1F1F1F] text-sm font-medium px-4 py-3 rounded-lg flex items-center justify-center gap-2 transition-all duration-300 disabled:opacity-70"
          >
